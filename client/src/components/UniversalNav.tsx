  ...
  return (
    <div className="fixed top-4 left-4 z-50 flex gap-2 sm:gap-3">
      <Button
        ...
        size="sm"
        onClick={goBack}
        className="flex items-center gap-1 sm:gap-2 bg-white/95 backdrop-blur-md border shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all duration-200 px-2 sm:px-3 py-1.5 text-xs sm:text-sm font-medium touch-manipulation"
      >
      ...
      <Button
        ...
        size="sm"
        onClick={goHome}
        className="flex items-center gap-1 sm:gap-2 bg-white/95 backdrop-blur-md border shadow-lg hover:bg-primary/10 hover:shadow-xl hover:border-primary/20 transition-all duration-200 px-2 sm:px-3 py-1.5 text-xs sm:text-sm font-medium touch-manipulation"
      >
